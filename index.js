...
const addEmployee = async () => {
    const employeesQuestions = questions.addEmployeeQuestions;
    const employees = await db.getAllDepartments();
    ...
    employeeQuestions[3].choices = employeeQuestions[3].choices.contact(employees.map(emp => {
        return {
